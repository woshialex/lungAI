...
def dice_coef_loss_gen(smooth=10, pred_mul=1.0, p_ave=0.6, p_cross=0.5):
    def loss(y_true, y_pred):
        return -(1-p_cross)*dice_coef(y_true, y_pred, smooth, pred_mul, p_ave) + p_cross*binary_crossentropy(y_true,y_pred);
    return loss
